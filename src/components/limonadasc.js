...
import styles from '../styles/limonadas.module.css';
...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/limonada_pepino.png',
      alt: 'Natural o mineral',
      colorClass: styles.enlace_imagen_americano,
      text: 'LIMONADA DE PEPINOS',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/limonada_melon.png',
      alt: 'Coca cola original o sin azúcar o light, Fanta naranja, Sprite o Sidral Mundet.',
      colorClass: styles.enlace_imagen_hc,
      text: 'LIMONADA DE MELÓN',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/limonada_arandanos.png',
      alt: 'Coca cola original o sin azúcar o light, Fanta naranja, Sprite, Sidral Mundet y Agua mineral Ciel.',
      colorClass: styles.enlace_imagen_mini,
      text: 'LIMONADA DE ARÁNDANOS',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/strongbow_red.png',
      alt: '600 ml',
      colorClass: styles.enlace_imagen_marinerito,
      text: 'LIMONADA STRONGBOW BERRIES',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/strongbow_honey.png',
      alt: '600 ml',
      colorClass: styles.enlace_imagen_combinadito,
      text: 'LIMONADA STRONGBOW HONEY', 
    },
  ];
  ...
  return ( 
    <>
    <Head>
        <title>Limonadas Vips | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>LIMONADAS VIPS</h1>
