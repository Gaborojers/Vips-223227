...
function Dia() {
    ...
    const images = [
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/chilaquiles_nortenos.jpg',
          alt: '300 ml',
          colorClass: styles.enlace_imagen_tacos,
          text: 'CHILAQUILES NORTEÑOS CON MACHACA',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/chilaquiles_suizos_con_milanesa.jpg',
          alt: '420 ml',
          colorClass: styles.enlace_imagen_papa,
          text: 'CHILAQUILES SUIZOS',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/toluquenno.jpg',
          alt: '',
          colorClass: styles.enlace_imagen_pollo,
          text: 'CHILAQUILES TOLUQUEÑOS',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/chilaquiles_rojos.jpg',
          alt: 'Caramelo (370 Cal), vainilla (300 Cal) o avellana (290 Cal). 420 ml.',
          colorClass: styles.enlace_imagen_pechuga,
          text: 'CHILAQUILES VIPS',
        },
        {
            src: 'https://vips.com.mx/menu/imgpreview/platos/chilaquiles_verdes_huevo.jpg',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
            colorClass: styles.enlace_imagen_salpicon,
            text: 'CHILAQUILES VERDES CON HUEVO',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/chilaquiles-rojos-huevo.jpg',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
            colorClass: styles.enlace_imagen_enchiladas,
            text: 'CHILAQUILES ROJOS CON HUEVO',
          },
      ];
  ...
  return ( 
    <>
    <Head>
        <title>Enchiladas y Chilaquiles | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>CHILAQUILES</h1>
      ...
      <div className={styles.imageGrid}>
        {images.map((image, index) => (
          ...
          >
            ...
            <div className={styles.cuadro_color_pechuga}>
              <p>{image.text}</p>
            </div> 
          </div>
        ))}
