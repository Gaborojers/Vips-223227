...
function Dia() {
    ...
    const images = [
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/americano.jpg',
          alt: '300 ml',
          colorClass: styles.enlace_imagen_tacos,
          text: 'AMERICANO O DESCAFEINADO (RELLENABLE)',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/cafe.jpg',
          alt: '420 ml',
          colorClass: styles.enlace_imagen_papa,
          text: 'ESPRESSO',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/capuchino.jpg',
          alt: '',
          colorClass: styles.enlace_imagen_pollo,
          text: 'CAPPUCCINO',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/capuchino_caramelo.jpg',
        ...
        {
            src: 'https://vips.com.mx/menu/imgpreview/platos/bebidas-vaso-con-leche.png',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
            colorClass: styles.enlace_imagen_salpicon,
            text: 'LECHE',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/chocolate_caliente.jpg',
            alt: 'Con leche entera, deslactosada o light. 420 ml',
            colorClass: styles.enlace_imagen_enchiladas,
            text: 'CHOCOLATE CALIENTE',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/ChocolateFrio.png',
            alt: 'Con leche entera, deslactosada o light. 360 ml',
            colorClass: styles.enlace_imagen_res,
            text: 'CHOCOLATE FRIO',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/teflordelapaz.jpg',
            alt: '1 pieza (500 ml) Libre de calorías',
            colorClass: styles.enlace_imagen_milanesa,
            text: 'TÉ FLOR DE LA PAZ',
          },
      ];
  ...
  return ( 
    <>
    <Head>
        <title>Café y chocolate para desayunar | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>CAFETERÍA</h1>
      <br />
      <br />
      <br />
      <br /> 
      ...
      <div className={styles.imageGrid}>
        {images.map((image, index) => (
          ...
          >
            ...
            <div className={styles.cuadro_color_papa}>
              <p>{image.text}</p>
            </div>
          </div>
        ))}
