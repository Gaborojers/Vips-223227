...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/papas_carita.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_verduras,
      text: 'PEPITAS VIPS',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/crepita2.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_fideos,
      text: 'CREPITA CON CAJETA',
    }, 
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/Bola-de-helado-fresa.jpg',
      alt: '420 ml',
  ...
  return ( 
    <>
    <Head>
        <title>Adicionales infantiles | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>ADICIONALES</h1>
