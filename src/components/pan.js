...
function Dia() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/bisquets_con_mermelada.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_tacos,
      text: 'BÍSQUETS CON MERMELADA DE FRESA',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/bisquetscrema.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_papa,
      text: 'BÍSQUETS CON QUESO CREMA Y FRESAS',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/pan_dulce.jpg',
      alt: '',
      colorClass: styles.enlace_imagen_pollo,
      text: 'PAN DULCE',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/dona.jpg',
      alt: 'Caramelo (370 Cal), vainilla (300 Cal) o avellana (290 Cal). 420 ml.',
      colorClass: styles.enlace_imagen_pechuga,
      text: 'DONAS',
    },
    {
        src: 'https://vips.com.mx/menu/imgpreview/platos/paquete-donas.jpg',
        alt: 'Entera, baja en grasa o deslactosada. 360 ml',
        colorClass: styles.enlace_imagen_salpicon,
        text: 'PAQUETE 6 DONAS',
      },
  ];
  ...
  return ( 
    <>
    <Head>
        <title>Panadería para ti | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>PANADERÍA</h1>
      <br />
      <br />
      <br /> 
      <br />
      ...
      <div className={styles.imageGrid}>
        {images.map((image, index) => (
          ...
          >
            ...
            <div className={styles.cuadro_color_pollo}>
              <p>{image.text}</p>
            </div>
          </div>
        ))}
