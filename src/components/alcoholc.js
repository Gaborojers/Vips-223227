...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/cerveza.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_verduras,
      text: 'CERVEZA',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/cervezas_esp.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_fideos,
      text: 'CERVEZA ESPECIAL',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/sangria.png',
      alt: '420 ml',
  ...
  return ( 
    <>
    <Head>
        <title>Bebidas con alcohol | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>BEBIDAS CON ALCOHOL</h1>
