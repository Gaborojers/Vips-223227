...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/combinado.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_verduras,
      text: 'COMBINADO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/hotcakes_tradicionales.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_fideos,
      text: 'HOT CAKES TRADICIONALES',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/pan_frances_2.jpg',
      alt: '',
  ...
  return ( 
    <>
    <Head>
        <title>Hot Cakes y Pan Francés | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>HOT CAKES Y PAN FRANCÉS</h1>
      <p style={{ fontSize: '19px', textAlign: 'center' }} className={styles.frase}>
      Incluyen: Un jugo (300 ml /173 Cal, toronja o naranja) o fruta (150 g /59 Cal, melón, papaya o piña, (sujeto a disponibilidad) y café americano (300 ml / Rellenable/ Libre de Cal) Servidos de 7:00 a 13:00 hrs. Cambia tu café por un Té flor de la paz $11.
      </p>
       <br />
