...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/ensalada-chef.png',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_verduras,
      text: 'DEL CHEF CON PECHUGA MARINADA',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/ensalada.jpg',
      alt: '420 ml',
  ...
  return ( 
    <>
    <Head>
        <title>Ensaladas y Crepas | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>ENSALADAS</h1>
      ...
      <div className={styles.imageGrid}>
        {images.map((image, index) => (
          ...
          >
            ...
            <div className={styles.cuadro_color_fideos}>
              <p>{image.text}</p>
            </div>
          </div>
        ))}
