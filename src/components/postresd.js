...
function Dia() {
    ...
    const images = [
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/pay_limon.jpg',
          alt: '300 ml',
          colorClass: styles.enlace_imagen_tacos,
          text: 'PAY DE LIMÓN',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/cheesecake_con_fresas.jpg',
          alt: '420 ml',
          colorClass: styles.enlace_imagen_papa,
          text: 'CHEESECAKE CON FRESAS',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/pastel_triple_chocolate.jpg',
          alt: '',
          colorClass: styles.enlace_imagen_pollo,
          text: 'PASTEL TRIPLE CHOCOLATE',
        },
        { 
          src: 'https://vips.com.mx/menu/imgpreview/platos/crepas_bicolor_2.jpg',
          alt: 'Caramelo (370 Cal), vainilla (300 Cal) o avellana (290 Cal). 420 ml.',
          colorClass: styles.enlace_imagen_pechuga,
          text: 'CREPAS BICOLOR',
        },
        {
            src: 'https://vips.com.mx/menu/imgpreview/platos/crepas_cajeta.jpg',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
            colorClass: styles.enlace_imagen_salpicon,
            text: 'CREPAS DE CAJETA',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/malteadas2023.jpg',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
  ...
  return ( 
    <>
    <Head>
        <title>Malteadas y postres | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>POSTRES</h1>
      <br />
      <br />
      <br />
      <br />
