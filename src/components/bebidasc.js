...
import styles from '../styles/bebidasc.module.css';
...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/bebidas-agua-fresca.png',
      alt: 'Natural o mineral',
      colorClass: styles.enlace_imagen_americano, 
      text: 'AGUA FRESCA',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/limonada.jpg',
      alt: 'Coca cola original o sin azúcar o light, Fanta naranja, Sprite o Sidral Mundet.',
      colorClass: styles.enlace_imagen_hc,
      text: 'LIMONADA O NARANJADA',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/refresco_lata.jpg',
      ...
      text: 'REFRESCO EN LATA',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/bebidas-refresco-cola.png',
      alt: '600 ml',
      colorClass: styles.enlace_imagen_marinerito,
      text: 'REFRESCO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/epura.jpg',
      alt: '600 ml',
  ...
  return ( 
    <>
    <Head>
        <title>Bebidas para la comida | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>BEBIDAS</h1>
      ...
      <div className={styles.imageGrid}>
        {images.map((image, index) => (
          ...
          >
            ...
            <div className={styles.cuadro_color_americano}>
              <p>{image.text}</p>
            </div>
          </div>
        ))}
