...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/americanito.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_americano,
      text: 'DESAYUNITO AMERICANO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/hc.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_hc,
      text: 'HOT CAKES JR',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/mini-molletes.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_mini,
      text: 'MINI OMELETTESL',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/marinerito.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_marinerito,
      text: 'MARINERITO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/Combinadito.jpg',
      alt: '420 ml',
  ...
  return (  
    <>
    <Head>
        <title>Desayuno infantil | Vips México</title>
