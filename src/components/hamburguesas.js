...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/hb_gratinda.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_verduras,
      text: 'BBQ GRATINADA',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/clasica_conqueso.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_fideos,
      text: 'VIPS CLASICA CON QUESO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/hchampions.jpg',
      alt: '300 ml',
  ...
  return ( 
    <>
    <Head>
        <title>Restaurante de hamburguesas | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>HAMBURGUESAS</h1>
