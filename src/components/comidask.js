...
import styles from '../styles/comidask.module.css';
...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/sabanita.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_americano,
      text: 'SABANITA AVENTURA DE RES',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/pescadito2.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_hc,
      text: 'PESCADITO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/hamburguesita_queso.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_mini,
      text: 'HAMBURGUESITAS CON QUESO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/milanesita-de-pollo.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_marinerito,
      text: 'MILANESITA DE POLLO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/Taquitos.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_combinadito,
      text: 'TAQUITOS DORADOS',
    },
  ];
  ...
  return ( 
    <>
    <Head>
        <title>Tu comida completa | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      Todos nuestros desayunos incluyen un obsequio (sujeto a disponibilidad).
      </p>
       <br />
