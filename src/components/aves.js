...
import styles from '../styles/aves.module.css';
...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/pechuga_limon.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_americano,
      text: 'PECHIGA PARRILLA AL LIMÓN', 
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/pechuga_mixteca.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_hc,
      text: 'PECHUGA MIXTA',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/milanesa_tradicional.jpg',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_mini,
      text: 'MILANESA TRADICIONAL', 
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/milanesa_hawaiana.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_marinerito,
      text: 'MILANESA HAWAIANA',
    },
  ];
  ...
  return ( 
    <>
    <Head>
        <title>Plastillos con Aves y Pescados | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>AVES</h1>
      ...
      <div className={styles.imageGrid}>
        {images.map((image, index) => (
          ...
          >
            ...
            <div className={styles.cuadro_color_combinadito}>
              <p>{image.text}</p>
            </div>
          </div>
        ))}
