...
import styles from '../styles/carnes.module.css';
...
function Dia() {
    ...
    const images = [
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/new_york_gtill.jpg',
          alt: '300 ml',
          colorClass: styles.enlace_imagen_tacos,
          text: 'NEW YORK GRILL',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/carne_Asada.jpg',
          alt: '420 ml',
          colorClass: styles.enlace_imagen_papa,
          text: 'CARNE ASADA',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/arrachera_nortena.jpg',
          alt: '',
          colorClass: styles.enlace_imagen_pollo,
          text: 'ARRACHERA NORTEÑA',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/cecina.jpg',
          alt: '',
          colorClass: styles.enlace_imagen_pechuga,
          text: 'CECINA MORELOS',
        },
        {
            src: 'https://vips.com.mx/menu/imgpreview/platos/milanesa_Tampico.jpg',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
            colorClass: styles.enlace_imagen_salpicon,
            text: 'MILANESA TAMPICO',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/filete_tilapia_empamizado.jpg',
            alt: 'Con leche entera, deslactosada o light. 420 ml',
            colorClass: styles.enlace_imagen_enchiladas,
            text: 'FILETE DE TILAPIA A LA PLANCHA O EMPANIZADO',
          },
      ];
  ...
  return (
    <>
    <Head>
        <title>Carnes y acompañamientos | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>CARNES Y PESCADOS</h1>
      <br />
      <br />
      <br />
      <br />
