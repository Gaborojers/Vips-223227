...
function Clasicos() {
  ...
  const images = [
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/Guacamole-modif.png',
      alt: '300 ml',
      colorClass: styles.enlace_imagen_verduras,
      text: 'GUACAMOLE',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/plato_mixto.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_fideos,
      text: 'PLATO MIXTO',
    },
    {
      src: 'https://vips.com.mx/menu/imgpreview/platos/espiropapas.jpg',
      alt: '420 ml',
      colorClass: styles.enlace_imagen_vips,
      text: 'ESPIROPAPAS VIPS',
    },
  ];
  ...
  return (  
    <>
    <Head>
        <title>Entradas con guacamole | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>ENTRADAS</h1>
