...
import styles from '../styles/clasicos.module.css';
...
function Clasicos() {
    ...
    const images = [
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/cmama_suizas.jpg',
          alt: '300 ml',
          colorClass: styles.enlace_imagen_enfrijoladas,
          text: 'ENFRIJOLADAS',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/cmama_caldo.jpg',
          alt: '420 ml',
          colorClass: styles.enlace_imagen_vips,
          text: 'MOLLETES VIPS',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/cmama_enfrijoladas.jpg',
          alt: '',
          colorClass: styles.enlace_imagen_caldo,
          text: 'CALDO TLALPEÑA',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/cmama_mole.jpg',
          alt: 'Caramelo (370 Cal), vainilla (300 Cal) o avellana (290 Cal). 420 ml.',
          colorClass: styles.enlace_imagen_mole,
          text: 'ENCHILADAS DE MOLE',
        },
        {
            src: 'https://vips.com.mx/menu/imgpreview/platos/cmama_molletes.jpg',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
            colorClass: styles.enlace_imagen_huaraches,
            text: 'HUARACHE VIPS',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/cmama_tacos_dorados.jpg',
            alt: 'Con leche entera, deslactosada o light. 420 ml',
            colorClass: styles.enlace_imagen_tacos,
            text: 'TACOS DORADOS DE POLLO',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/clasicos_sopa_tortilla.jpg',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
            colorClass: styles.enlace_imagen_sopa,
            text: 'SOPA DE TORTILLA',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/cmama_tostadas.jpg',
            alt: 'Con leche entera, deslactosada o light. 420 ml',
  ...
  return ( 
    <>
    <Head>
        <title>Vivan los clásicos | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>FAMILIA DE CLÁSICOS</h1>
      ...
      <div className={styles.imageGrid}>
        {images.map((image, index) => (
          ...
          >
            ...
            <div className={styles.cuadro_color_mole}>
              <p>{image.text}</p>
            </div>
          </div>
        ))}
