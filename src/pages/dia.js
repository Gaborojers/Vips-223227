...
function Dia() {
    ...
    const images = [
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/mdd_estrellados_chilaquiles.jpg',
          alt: '300 ml',
          colorClass: styles.enlace_imagen_tacos,
          text: 'ESTRELLADOS CON CHILAQUILES',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/mdd_huevos_huarachito.jpg',
          alt: '420 ml',
          colorClass: styles.enlace_imagen_papa,
          text: 'HUEVOS CON HUARACHITO',
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/mdd_enchiladas_tradicionales.jpg',
          alt: '',
          colorClass: styles.enlace_imagen_pollo,
          text: 'ENCHILADAS TRADICIONALES', 
        },
        {
          src: 'https://vips.com.mx/menu/imgpreview/platos/mddd_chilaquiles_nortenos_huevo.jpg',
          alt: '',
          colorClass: styles.enlace_imagen_pechuga,
          text: 'CHILAQUILES NORTEÑOS CON HUEVO',
        },
        {
            src: 'https://vips.com.mx/menu/imgpreview/platos/mdd_omelette_divorciado.jpg',
            alt: 'Entera, baja en grasa o deslactosada. 360 ml',
            colorClass: styles.enlace_imagen_salpicon,
            text: 'COMELETTE DIVORCIADO',
          },
          {
            src: 'https://vips.com.mx/menu/imgpreview/platos/mddd_huevos_oaxaca.jpg',
  ...
  return ( 
    <>
    <Head>
        <title>Menú del día | Vips México</title>
    ...
    <div className={`${styles.pagina}`}>
      ...
      <h1  className={styles.maintitle}>MENÚS DEL DÍA</h1>
      
      <div className={styles.pasosmdd}>
            <h3>
                <i>1</i>
                Elige tu platillo
            </h3>
        ...
        <div className={styles.pasosmdd2}>
            <h3>
                <i>2</i>
                Elige jugo o fruta
            </h3>
            <p>
                Piña (150 g), Papaya (150 g), Melón (150 g), Jugo de naranja (300 ml) o Jugo de toronja (300 ml)
            </p>
        </div>

        <div className={styles.pasosmdd3}>
            <h3>
                <i>3</i>
                Pide tu café
            </h3>
            <p>
                Café americano regular o descafeinado (Rellenable)
            </p>
        </div>
